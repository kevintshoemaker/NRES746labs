...
grade_this({
  ...
  fail_if(!near(.result(MCMC1=jags.fit_ricker,MCMC2=jags.fit_mm)[[1]][1],
              .solution(MCMC1=jags.fit_ricker,MCMC2=jags.fit_mm)[[1]][1],0.1))
  fail_if(!near(.result(MCMC1=jags.fit_ricker,MCMC2=jags.fit_mm)[[1]][2],
              .solution(MCMC1=jags.fit_ricker,MCMC2=jags.fit_mm)[[1]][2],0.1))
  pass_if(near(sum(apply(.result(MCMC1=jags.fit_ricker,MCMC2=jags.fit_mm),2,mean)),
              sum(apply(.solution(MCMC1=jags.fit_ricker,MCMC2=jags.fit_mm),2,mean)),1))
  fail()
})
```
