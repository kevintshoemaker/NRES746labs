...
+ **suggested algorithm**:   
    + up to you!  (HINT: use binomial distribution) (Note: do not use 'optim()' here: you are just asked to compute the likelihood at the specified parameters, not to find the maximum likelihood estimate)

+ **return**:    
    + the negative log likelihood of all observations (a single number)   
