...
# editor_options:
#   preview: viewer
description: "Getting started with writing algorithms in R!"
---
...
In this course we use the R programming language for statistical computing and graphics (e.g., this lab is actually built in R using ['Rmarkdown'](https://rmarkdown.rstudio.com/) and [Rshiny](https://shiny.rstudio.com/)). The purpose of this laboratory exercise is to develop familiarity with programming in R. 
...
**Hint:** Try running with different values for the 'N' parameter.
</div>
