...
```{r functest-check}
grade_this(
  pass_if_equal(.solution(3:4),.result(3:4)),
  fail()
)
...
this.grader(mock_this_exercise(
    ...
    .solution_code = "sum(2:3)"  # from -solution chunk
  ))
...
You can use this "sandbox" (below) to develop and test your function! Make sure the last line in the code stays as is- otherwise the answer checker won't work!
