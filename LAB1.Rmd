...
check_functest <- function(USER_CODE){
    ...
    func_call <- line_where(code,insist(F=="myfunc","Use function 'myfunc()'"))
    line_where(func_call, insist(V==10, "Your solution is {{V}}. This is not the correct result"),passif(TRUE, "Great job!"))
}
...
check_q1a <- function(USER_CODE){
    code <- for_checkr(USER_CODE)
    func_call <- line_where(code,insist(F== "CoefVar","Use CoefVar() function!"))
    t1 <- line_where(func_call, insist(all(V==answer1a), "Your solution is {{V}}. This is not the correct result"),passif(TRUE, "Great job!"))
}
check_q1a(USER_CODE)
```
...
check_q1b <- function(USER_CODE){
    code <- for_checkr(USER_CODE)
    func_call <- line_where(code,insist(F== "DrawLine","Use DrawLine() function!"))
    t1 <- line_where(func_call, insist(all(V==answer1b), "Your solution is {{V}}. This is not the correct result"),passif(TRUE, "Great job!"))
}
check_q1b(USER_CODE)
...
check_q1c <- function(USER_CODE){
    code <- for_checkr(USER_CODE)
    func_call <- line_where(code,insist(F== "DrawLine2","Use DrawLine2() function!"))
    t1 <- line_where(func_call, 
        insist(all(V$fitted == answer1c$fitted), 
        "Sorry, that's not correct"),
        passif(TRUE, "Fantastic!"))
}
check_q1c(USER_CODE)
```
...
code <- for_checkr(quote({xvec <- c(1:10)
                          set.seed(100)    # don't change this line, or the answer checking function won't work!
                          yvec <- rnorm(length(xvec),c(2:6,7:3),2)
                          DrawLine2 <- function(x,y,smooth=F,span=1){
                              plot(y~x)
...
func_call <- line_where(code,insist(F== "DrawLine2","Use DrawLine2() to construct the model."))
#func_call <- line_binding(code, DrawLine2, message = "Use DrawLine2() to construct the model.")
t1 <- line_where(func_call, 
        insist(all(V$fitted == answer1c$fitted) , "Sorry, that's not correct"),
        passif(TRUE, "Great job!"))
...
# t1 <- line_where(code,insist(V %same_as% answer1c, message = "Sorry, try again!"))
# passif(any(func_call$values[[length(func_call$values)]]$fitted==answer1c$fitted),"Right!")
# #t1 <- line_where(func_call, insist(V==8.49, "Sorry, this is not the correct result"),passif(TRUE, "Fantastic!"))
...
check_q1d <- function(USER_CODE){
    code <- for_checkr(USER_CODE)
    func_call <- line_where(code,insist(F== "CLTdemo","Use CLTdemo() function!"))
    t1 <- line_where(func_call, 
        insist(V$p.value <= 0.01, 
        "Sorry, that's not correct"),
        passif(TRUE, "Fantastic!"))
}
check_q1d(USER_CODE)
...
check_q4a <- function(USER_CODE){
    code <- for_checkr(USER_CODE)
    func_call <- line_where(code,insist(F== "t.test.onetail","Use t.test.onetail() function!"))
    t1 <- line_where(func_call, 
        insist(all(V$p_value <= 0.02), 
        "Sorry, that's not correct"),
        passif(TRUE, "Very nice!"))
}
check_q4a(USER_CODE)
```
...
check_q4b <- function(USER_CODE){
    code <- for_checkr(USER_CODE)
    func_call <- line_where(code,insist(F== "t.test.vardif","Use t.test.vardif() function!"))
    t1 <- line_where(func_call, 
        insist(all((V$p_value >=  (answer4b$p_value-0.2))&(V$p_value <=  (answer4b$p_value+0.2))), 
        "Sorry, that's not correct"),
        passif(TRUE, "Bravo!"))
}
check_q4b(USER_CODE)
...
check_q4c <- function(USER_CODE){
    code <- for_checkr(USER_CODE)
    func_call <- line_where(code,insist(F== "t.test.ndif","Use t.test.ndif() function!"))
    t1 <- line_where(func_call, 
        insist(all((V$p_value >=  (answer4c$p_value-0.15))&(V$p_value <=  (answer4c$p_value+0.15))), 
        "Sorry, that's not correct"),
        passif(TRUE, "Bravo!"))
}
check_q4c(USER_CODE)
...
check_q5a <- function(USER_CODE){
    code <- for_checkr(USER_CODE)
    func_call <- line_where(code,insist(F== "RegressionCoefs","Use RegressionCoefs() function!"))
    t1 <- line_where(func_call, 
        insist(any((V ==  answer5a)), 
        "Sorry, that's not correct"),
        passif(TRUE, "Bravo!"))
}
check_q5a(USER_CODE)
...
check_q5b <- function(USER_CODE){
    code <- for_checkr(USER_CODE)
    func_call <- line_where(code,insist(F== "BootCoefs","Use BootCoefs() function!"))
    t1 <- line_where(func_call, 
        insist(all((V[1,3] >=  (answer5b[1,3]-0.2))&(V[1,3] <=  (answer5b[1,3]+0.2))), 
        "Sorry, that's not correct"),
        passif(TRUE, "Delightful!"))
}
check_q5b(USER_CODE)
```
