...
# NOTE USE THIS VERSION- THIS IS THE UPDATED VERSION
```
...
```{r dataq1a0, echo=FALSE, context="data"}
...
```{r q1a-check}
grade_this({
  pass_if_equal(y=.solution(trees$Height[-4]),x=.result(trees$Height[-4]))
  fail()
})
```
...
```{r dataq1b0, echo=FALSE, context="data"}
...
```{r dataq1c0, echo=FALSE, context="data"}
...
```{r dataq1d0, echo=FALSE, context="data"}
