...
```{r functest_test, echo=FALSE, eval=FALSE}
...
grade_this(pass_if_equal(!!.solution(3:4),!!.result(3:4)),
...
```{r q1c-check}
grade_this({
  pass_if(all(.result(faithful$waiting,faithful$eruptions,F)==.solution(faithful$waiting,faithful$eruptions,F)))
